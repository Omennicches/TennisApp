...
internal object PaletteTokens {
    ...
    val Secondary40 = Color(red = 223, green = 255, blue = 79, alpha = 255)
    ...
    val Secondary80 = Color(red = 200, green = 244, blue = 0, alpha = 255)
    val Secondary90 = Color(red = 223, green = 255, blue = 79, alpha = 50)
    val Secondary95 = Color(red = 255, green = 255, blue = 255, alpha = 125)
    val Secondary99 = Color(red = 200, green = 244, blue = 0, alpha = 50)
    ...
    val Tertiary40 = Color(red = 84, green = 169, blue = 25)
    ...
    val Tertiary80 = Color(red = 36, green = 72, blue = 11, alpha = 255)
